...
param publisherEmail string = 'company@terraform.io'
...
module appInsightsModule '../../../iac-modules/bicep/appInsights.bicep' = {
  name: 'aiDeploy'
  params: {
    location:location
...
module functionModule '../../../iac-modules/bicep/function.bicep' = {
  name: 'functionDeploy'
  params: {
    location:location
...
module apimmodule '../../../iac-modules/bicep/apim.bicep' = {
  name: 'apimDeploy'
  params: {
    location:location
