terraform {
  ...
  #
  #   terraform init \
  #     -backend-config="resource_group_name=rg-ai-foundry-network-dev-westus3" \
  ...
  #     "/subscriptions/<sub>/resourceGroups/rg-ai-foundry-network-dev-westus3/providers/Microsoft.Storage/storageAccounts/sttfs<hash>"
  #
